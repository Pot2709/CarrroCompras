...
using CapaEntidad;
using CapaNegocio;
using System.Web.Security;//esta es la referencia para la funcion
    ...
    public class AccesoController : Controller
    {
        ...
        public ActionResult Index(string correo, string clave)
        {
            ...
            else
            {
                ...
                FormsAuthentication.SetAuthCookie(oUsuario.Correo, false); //con esta referencia una authenticacion para que no entre a travez de url
        ...
        public ActionResult Reestablecer(string correo)
        {
            ...
            if (ousuario == null)
            {
                ViewBag.Error = "No se encontró a un usuario relacionado a ese correo";
                return View();
            }
            string mensaje = string.Empty;
